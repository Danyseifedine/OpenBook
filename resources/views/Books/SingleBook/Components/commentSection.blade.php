@guest
    <section class="container p-1 mb-12">
        ...
        <div class="comments-container comment mt-2 rounded m-1">
            {{-- each --}}
            @if (count($comments))
                ...
                @endforeach
            @else
                <div class="empty-comment-section text-center" style="color: rgba(0, 136, 255, 0.483)">@lang('messages.noComment')</div>
            @endif
        </div>
    </section>
@endguest
    ...
    <section class="container p-1 mb-12">
        ...
        <div class="comments-container comment mt-4 rounded m-1">
            ...
            @if (count($allcomment) >= 5)
                <a href="{{ route('allComment', encrypt($book->id)) }}"><button class="allcomment">@lang('messages.allCommentCheck')</button></a>
            @endif
        </div>
    </section>
