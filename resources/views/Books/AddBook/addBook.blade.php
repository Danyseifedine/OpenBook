...
@section('content')
    <div class="container" style="margin-top:120px">
        <a href="{{ url()->previous() }}"><i class="ri-arrow-left-line text-3xl"></i></a>

        <h1 class="text-4xl mb-3 text-blue-900">Add book
            <hr class="w-1/6">
        </h1>
    </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2 info-card-add-book mt-12 p-5">
                ...
                <div class="mb-3">
                    ...
                    <select
                        ...
                        <option value="" style="background:#3672da;color:white">اختر تصنيفًا</option>
                ...
                <div class="mb-3">
                    ...
                    <select name="book_language_arabic"
                        class="_input text-black form-select form-control block w-full px-4 py-3 pr-8 leading-tight border border-gray-300 rounded-lg appearance-none focus:outline-none focus:ring focus:border-blue-500">
                        <option value="" style="background:#3672da;color:white">اختر لغة</option>
                ...
                <div class="mb-3 col-span-2">
                    ...
                    <textarea type="text" rows="10" placeholder="Book description in english"
                        class="_input text-black form-select form-control block w-full px-4 py-3 pr-8 leading-tight border border-gray-300 rounded-lg appearance-none focus:outline-none focus:ring focus:border-blue-500"
                        id="published_date" name="book_description" required></textarea>
                </div>
                <div class="mb-3 col-span-2">
                    ...
                    <textarea type="text" rows="10" placeholder="Book description in arabic"
                        class="_input text-black form-select form-control block w-full px-4 py-3 pr-8 leading-tight border border-gray-300 rounded-lg appearance-none focus:outline-none focus:ring focus:border-blue-500"
                        id="published_date" name="book_description_arabic" required></textarea>
                </div>
                <div class="mb-3">
                    ...
                    <select
                        ...
                        <option value="" style="background:#3672da;color:white">Select a rate</option>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" id="title" name="book_cover" required>
                </div>
                <button type="submit" class="bg-blue-500 p-2 rounded text-white mt-5">Add Book</button>
