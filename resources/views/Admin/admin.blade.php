...
@section('section')
    ...
    <section class="home-section">
        <div
            class="min-w-screen min-h-screen bg-gray-100 flex flex-col justify-center bg-gray-100 font-sans  overflow-hidden">
            ...
            <div class="w-full lg:w-6/6">
                <div class="flex justify-center">
                    <div class="p-5 font-semibold text-2xl">
                        <h1 class="text-gray-800">Books</h1>
                    </div>
                </div>
                <div class="ag-format-container">
                    <div class="ag-courses_box">
                        ...
                        <div class="ag-courses_item">
                            <a href="#" class="ag-courses-item_link">
                                ...
                                <div class="ag-courses-item_title">
                                    Most Downloaded book category
                                </div>

                                <div class="ag-courses-item_date-box">
                                    Category :
                                    <span class="ag-courses-item_date">
                                        {{ $mostDownloadedBook->category }}
                                    </span>
                                </div>
                            </a>
                        </div>
